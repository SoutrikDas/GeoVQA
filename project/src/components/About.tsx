...
const teamMembers: TeamMember[] = [
  ...
  { name: 'Arindam Das', rollNo: '(25AI06003)', github: 'https://github.com/0-Dark-Lucifer-0' },
  { name: 'Soutrik Das', rollNo: '(25AI06011)', github: 'https://github.com/SoutrikDas' },
  { name: 'Deepta Kiran Das', rollNo: '(25AI06005)', github: 'https://github.com/Deepta-Das' },
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8">
      ...
      <div className="mt-8 pt-8 border-t border-gray-200">
        ...
        <a
          href="https://github.com/SoutrikDas/GeoVQA"
          target="_blank"
          rel="noopener noreferrer"
